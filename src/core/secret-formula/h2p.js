...
<br>
<br>
You start with 1 Logic Point. To increase Logic Points, you may exchange at most ${formatInt(6)} types of resources (${makeEnumeration(ResourceExchange.all.filter(r => r.isUnlocked).map(r => r.name))}) for different multipliers to the total Logic Points. You can level up Exchange to unlock a new exchangeable resource. As long as you get enough Logic Points, just level up Exchange at once because it gives you a huge boost.
<br>
<br>
