...
export const resourceExchange = {
  antimatter: {
    ...
    value: value => {
      const baseValue = value.clampMax(DC.E20000).pow(0.05).times
      (value.add(1).log10()).times(0.1).add(1);
      const cappedValue = value.div(DC.E20000).clampMin(1);
  ...
  matter: {
    ...
    value: value => {
      const baseValue = value.clampMax(DC.E20000).pow(0.04).times(0.1).add(1);
      const cappedValue = value.div(DC.E20000).clampMin(1);
