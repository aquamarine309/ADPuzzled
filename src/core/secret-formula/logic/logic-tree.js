...
export const logicTree = {
  ...
  unlockDilation: {
    ...
    requirement: () => `Buy ${formatInt(12900)} 1st Dimensions and complete ${formatInt(8)} Logic Achievements`,
    symbol: "Ψ",
    checkEvent: GAME_EVENT.GAME_TICK_AFTER,
    checkRequirement: () => AntimatterDimension(1).bought >= 12900 && player.logicNodes.size >= 8,
    position: [0, 1],
